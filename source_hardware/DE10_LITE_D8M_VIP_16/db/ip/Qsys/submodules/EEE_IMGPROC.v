...
always@(*) begin
	...
	///using matlab values (didnt work), so tweaking
		...
		if(((hue < 13 && hue > 0) || (hue > 233 && hue < 255)) && (saturation > 163) && (saturation < 255) && (value > 126) && (value < 255))begin
			found_red = 1;
		end

		else if((hue > 129) && (hue < 178) && (saturation > 120) && (saturation < 255) && (value > 143) && (value < 255))begin
			found_blue = 1;
		end

		else if((hue > 12) && (hue < 33) && (saturation > 122) && (saturation < 255) && (value > 139) && (value < 255))begin
			found_yellow = 1;
		end
...
assign red_high   = found_red ? {8'hff, 8'd0, 8'd0} : {grey, grey, grey}; // Red areas highlighted as red - was red detect
assign blue_high  = found_blue ? {8'd0, 8'd0, 8'd255} : {grey, grey, grey}; // Blue areas highlighted as blue
assign yellow_high = found_yellow ? {8'd255, 8'd255, 8'd0} : {grey, grey, grey}; // Yellow areas highlighted as yellow
...
assign bb_active_yellow = (x == left_yellow && y < top_yellow && y > bottom_yellow) | (x == right_yellow && y < top_yellow && y > bottom_yellow) | (y == top_yellow && x > left_yellow && x < right_yellow) | (y == bottom_yellow && x > left_yellow && x < right_yellow);

wire bb_active_white;
assign bb_active_white = (x == left_white && y < top_white && y > bottom_white) | (x == right_white && y < top_white && y > bottom_white) | (y == top_white && x > left_white && x < right_white) | (y == bottom_white && x > left_white && x < right_white);
